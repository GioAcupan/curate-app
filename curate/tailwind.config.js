...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "heading-lg": ["32px", { lineHeight: "38.4px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "heading-md": ["24px", { lineHeight: "31.2px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "heading-sm": ["20px", { lineHeight: "28px", fontWeight: "700", letterSpacing: "-0.01em" }],
        ...
        caption: ["12px", { lineHeight: "16.8px", fontWeight: "600", letterSpacing: "0.06em" }],
        overline: ["11px", { lineHeight: "14.3px", fontWeight: "700", letterSpacing: "0.08em" }],
      },
      borderRadius: {
        pill: "100px",
      },
